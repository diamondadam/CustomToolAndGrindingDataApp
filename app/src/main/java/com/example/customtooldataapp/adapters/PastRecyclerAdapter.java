...
public class PastRecyclerAdapter extends RecyclerView.Adapter<PastRecyclerAdapter.TransactionViewHolder> {
    ...
    public PastRecyclerAdapter(Fragment fragment, LiveData<List<Transaction>> transactions){
        Log.d("PastRecycler", "Constructor");
    ...
    public TransactionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.d("PastRecycler", "onCreateViewHolder");
    ...
    public int getItemCount() {
        if(transactions.getValue() == null){
            Log.d("PastRecycler", "Transactions are null...");
            return 0;
        }else{
            Log.d("PastRecycler", "Size: " +  transactions.getValue().size());
